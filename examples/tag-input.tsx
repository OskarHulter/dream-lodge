...
const CrazyTags = () => {
	const tagifyRef1 = useRef<Tags | null>(null);
	const tagifyRefDragSort = useRef<DragSort | null>(null);
	...
	const clearAll = () => {
		tagifyRef1.current?.removeAllTags();
	};
	...
	return (
		<>
			...
			<button type="button" className="clearAllBtn" onClick={clearAll}>
				Clear All
			</button>
			<Tags
